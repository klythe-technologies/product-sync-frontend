...
const ProductFixes = (props: any) => {
  const rows = [
    {
      id: '1', product: { avatar }, potential: 'Low', status: 'Not approved', attention: 'new product'
    },
    {
      id: '2', product: { avatar }, potential: 'Low', status: 'Not approved', attention: 'new product'
    },
    {
      id: '3', product: { avatar }, potential: 'Low', status: 'Not approved', attention: 'new product'
    },
  ]
